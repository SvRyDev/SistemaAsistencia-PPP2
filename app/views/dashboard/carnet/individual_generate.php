      ...
      <form id="carnetIndividualForm">
        ...
        <div class="form-row">
          <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="anio_individual" name="anio_individual" value="----"  disabled>
          </div>
          ...
          <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="dni_estudiante" name="dni_estudiante" placeholder="Ingrese DNI" maxlength="8" data-validate="numeric"  required>
          </div>
        </div>
